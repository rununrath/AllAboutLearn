        ...
        <div class="row">
                ...
                <div class="col-md-12">
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active"> <!-- @may edit photo -->
                                <img class="slide-image" src="./photo/COVER-PLUG.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="slide-image" src="./photo/COVER-PLUG.jpg" alt="">
                            </div>
            ...
            <div class="col-md-3">
             <!--   <p class="lead">Shop Name</p>   -->
                <center>
                <p class="lead"><img src="./photo/map7.png" alt="" width="110px" >Admin</p>
                </center>
                <div class="list-group">
                    <a href="#" class="list-group-item" onclick="showUniversity()" >กรุงเทพฯ</a> <!--edit may -->
